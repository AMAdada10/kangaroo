...
kangaroo= createSprite(750,150,750,15);
kangaroo.addAnimation("running", kangaroo_running);
kangaroo.addAnimation("collided", kangaroo_collided);
kangaroo.scale=0.1
kangaroo.setCollider("rectangle",5,0,kangaroo.width,kangaroo.height);
kangaroo.debug = true




shrub=createSprite(200,190,200,10)
shrub.addAnimation("shrub1.png")
shrub.addAnimation("shrub2.png")
shrub.addAnimation("shrub3.png")
shrub.scale=0.1

//Create a sprite for Invisible ground and place it at the bottom side of the screen.
invisiblejungle = createSprite(150,10,350,15);
